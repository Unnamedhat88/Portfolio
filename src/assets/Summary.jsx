            ...
            <div className="relative mx-6 md:mx-16 lg:mx-32 my-10 lg:my-24 ">
                ...
                <div className="relative z-20 mx-4 my-4">
                    <div className="flex mx-4">
                        ...
                        <img className="pt-2 md:pt-4 cursor-pointer w-[60px] md:w-[80px] lg:w-[100px] h-auto object-contain" src="https://unnamedhat88.github.io/Portfolio/images/aws-certified-cloud-practitioner.png" style={{width:"120px"}} onClick={()=>window.open("https://www.credly.com/badges/e75079a6-a347-4a90-8cda-166e5c0dc61e/public_url","_blank")}></img>
                    </div>
